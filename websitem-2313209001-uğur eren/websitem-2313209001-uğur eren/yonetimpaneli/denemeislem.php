...
if (empty($baslik) || empty($icerik)) {
    ...
    $kullanici_id = $_SESSION['admin'];

    $sql = "INSERT INTO denemeler (kullanici_id, baslik, icerik) VALUES (?, ?, ?)";
...
$liste_sorgusu = "SELECT id, baslik, icerik FROM denemeler";
...
<body>
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-start mb-3">
            <a href="admin.php" class="btn btn-secondary me-3">Geri Dön</a>
        </div>
            ...
            <table class="table table-striped mt-3">
                ...
                <tbody>
                    ...
                    if ($liste_result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='3'>Henüz deneme bulunmamaktadır.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
