...
CREATE TABLE `menuler` (
  `idmenuler` int NOT NULL AUTO_INCREMENT,
  `menu_adi` varchar(45) NOT NULL,
  `gidilecekyer` varchar(45) NOT NULL,
  PRIMARY KEY (`idmenuler`)
...
INSERT INTO `menuler` VALUES (1,'Anasayfa','index.php'),(100,'Duyurular','duyurular.php'),(275,'Giriş Yap','giris.php'),(276,'Üye Ol','uyeol.php'),(280,'Profilim','profilim.php');
